      ...
      <div className="container m-5">
        <h4>Class-Based React</h4>
          <div className="timer-wrapper">
            <div className="col-xs-1 btn btn-primary" onClick={this.addTime}> + </div>
            <div className="col-xs-1">TIME: {this.formatMMSS(this.state.time.get('minutes'))}:{this.formatMMSS(this.state.time.get('seconds'))}</div>
            <div className="col-xs-1 btn btn-primary" onClick={this.subtractTime}> - </div>
            <div className="col-xs-1 btn btn-success" onClick={this.startTimer}>PLAY</div>
            <div className="col-xs-1 btn btn-danger" onClick={this.stopTimer}>STOP</div>
            <div className="col-xs-1 btn btn-warning" onClick={this.resetTimer}>RESET</div>
          </div>
      </div>
    );
  }
